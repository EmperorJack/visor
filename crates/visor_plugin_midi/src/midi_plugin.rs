...
use crate::config::MidiMappingConfig;
use crate::mapping::MidiMappingEvent;
use crate::mapping::{MidiMapping, MidiVariables};
...
extension!(
    ...
    esm_entry_point = "ext:visor_plugin_midi/src/midi-plugin.ts",
    esm = [
        "src/encoder.ts",
        "src/note.ts",
        "src/ops.ts",
...
impl Plugin for MidiPlugin {
    ...
    fn typescript_declaration(&self) -> Option<String> {
        Some(include_str!("midi-plugin.d.ts").into())
    }
